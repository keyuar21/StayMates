...
# 2. Build the image with the classic builder to guarantee a single image.
echo "🛠️ Building Docker image with classic builder..."
DOCKER_BUILDKIT=0 docker build -t "${REPOSITORY_NAME}:${IMAGE_TAG}" .
echo "✅ Build complete."
echo ""
...
echo ""
echo "🎉 Success! A single image has been pushed to your ECR repository."